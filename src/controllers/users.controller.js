...
async function httpGetAllUsers(req, res) {
  ...
  return res.status(response[200].statusCode).json(users);
}
...
async function httpPostUser(req, res) {
  ...
  return res.status(response[201].statusCode).json(newUser);
}
...
async function httpGetUserById(req, res) {
  ...
  return res.status(response[200].statusCode).json(user);
}
...
async function httpUpdateUser(req, res) {
  ...
  return res.status(response[200].statusCode).json(newUser);
}
